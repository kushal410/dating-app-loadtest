...
export const options = {
    stages: [
        { duration: '1m', target: 50 },     // Ramp-up: 0 → 50 VUs in 1 minute
        { duration: '2m', target: 200 },    // Ramp-up: 50 → 200 VUs in 2 minutes
        { duration: '2m', target: 500 },    // Ramp-up: 200 → 500 VUs in 2 minutes
        { duration: '2m', target: 800 },    // Ramp-up: 500 → 800 VUs in 2 minutes
        { duration: '2m', target: 1000 },   // Ramp-up: 800 → 1000 VUs in 2 minutes
        { duration: '2m', target: 500 },    // Ramp-down: 1000 → 500 VUs
        { duration: '2m', target: 200 },    // Ramp-down: 500 → 200 VUs
        { duration: '1m', target: 0 },      // Ramp-down: 200 → 0 VUs
    ],
    thresholds: {
